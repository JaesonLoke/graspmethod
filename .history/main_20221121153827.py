...
def main():
	...
	for i in range(1, 16):
		instances.append(f"./Instances/InstancesNodesSetC/Graph-{i}.txt")
	...
	for instance in instances:
		...
		file = open("./Output/InstancesNodesSetC- Output - Output/" + instance.replace("./Instances/InstancesNodesSetC/", "")
                    .replace(".clq", "") + ".txt", "w")
		file.write("FILE: " + instance.replace("./Instances/", "") + "\n")
		file.write("MAX CLIQUE: " + str(len(clique)) + "\n")
		file.write("EXECUTED TIME: " + str(excTime) + "s" + "\n")

		file.write("Clique vertices: " + str(clique))
